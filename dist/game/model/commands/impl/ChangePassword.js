...
var ChangePassword = /** @class */ (function () {
    ...
    ChangePassword.prototype.execute = function (player, command, parts) {
        // Known exploit
        if (command.includes("\r") || command.includes("\n")) {
            return;
        }
        var pass = command.substring(parts[0].length + 1);
    ...
    ChangePassword.prototype.changePassword = function (player, pass) {
        return __awaiter(this, void 0, void 0, function () {
            var passwordHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PasswordUtil_1.PasswordUtil.generatePasswordHashWithSalt(pass)];
                    case 1:
    ...
    ChangePassword.prototype.canUse = function (player) {
        return true;
    };
