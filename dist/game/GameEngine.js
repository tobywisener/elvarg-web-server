...
var GameEngine = /** @class */ (function () {
    ...
    GameEngine.prototype.init = function () {
        this.scheduler = schedule.scheduleJob("*/".concat(GameConstants_1.GameConstants.GAME_ENGINE_PROCESSING_CYCLE_RATE, " * * * * *"), this.run.bind(this));
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, World_1.World.process()];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
