...
var LoginDecoder = exports.LoginDecoder = /** @class */ (function () {
    ...
    LoginDecoder.prototype.decodeLogin = function (buffer, out) {
        ...
        if (buffer.length > 0) {
            ...
            if (uid != GameConstants_1.GameConstants.CLIENT_UID) {
                Server_1.Server.getLogger().info("[host= ".concat(ipAddress, "] was rejected for having the wrong UID."));
                LoginDecoder.sendLoginResponse(LoginResponses_1.LoginResponses.OLD_CLIENT_VERSION);
                return;
            }
